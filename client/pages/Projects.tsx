...
import { formatCurrency, getProjectStatusColor, getPriorityColor, formatDate, calculateProjectProgress } from "@/lib/utils"
import type { Project, ProjectStatus, ProjectPriority } from "@shared/crm-types"
...
const mockProjects: Project[] = [
  {
    ...
    timeline: {
      ...
      milestones: [
        { id: "m1", title: "Logo Design", description: "Initial logo concepts", dueDate: "2024-01-05", completed: true, completedAt: "2024-01-04" },
        { id: "m2", title: "Brand Guidelines", description: "Complete brand book", dueDate: "2024-01-10", completed: true },
        { id: "m3", title: "Print Materials", description: "Business cards and letterhead", dueDate: "2024-01-15", completed: false }
      ]
    },
    materials: [],
    attachments: [],
  ...
  },
  {
    ...
    timeline: {
      ...
      milestones: [
        { id: "m4", title: "Design Concepts", description: "Initial menu layouts", dueDate: "2023-12-25", completed: true, completedAt: "2023-12-24" },
        { id: "m5", title: "Client Review", description: "Present designs to client", dueDate: "2024-01-05", completed: true, completedAt: "2024-01-03" },
        { id: "m6", title: "Final Production", description: "Print final menus", dueDate: "2024-01-10", completed: false }
      ]
    },
    materials: [],
    attachments: [],
  ...
  },
  {
    ...
    timeline: {
      ...
      milestones: [
        { id: "m7", title: "Design Phase", description: "Create banner designs", dueDate: "2024-01-09", completed: false },
        { id: "m8", title: "Client Approval", description: "Get approval for designs", dueDate: "2024-01-10", completed: false },
        { id: "m9", title: "Production", description: "Print and deliver banners", dueDate: "2024-01-12", completed: false }
      ]
    },
    materials: [],
    attachments: [],
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredProjects.map((project) => {
          ...
          const isOverdue = new Date(project.timeline.estimatedEndDate) < new Date() && project.status !== 'completed'
